...
class TreeNode {
  ...
  TreeNode copyWith({String? label, String? id, List<TreeNode>? children, bool? hasChildren}) {
    return TreeNode(label: label ?? this.label, id: id ?? this.id, children: children ?? this.children, hasChildren: hasChildren ?? this.hasChildren);
  }
}
