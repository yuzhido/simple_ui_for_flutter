...
class SelectForTree extends StatefulWidget {
  final FormFiledConfig config;
  const SelectForTree({super.key, required this.config});
  @override
  State<SelectForTree> createState() => _SelectForTreeState();
}

class _SelectForTreeState extends State<SelectForTree> {
  @override
      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              LabelInfo(label: '组件内容', required: true),
