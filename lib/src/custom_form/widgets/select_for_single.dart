...
class SelectForSingle extends StatefulWidget {
  final FormFiledConfig config;
  const SelectForSingle({super.key, required this.config});
  @override
  State<SelectForSingle> createState() => _SelectForSingleState();
}

class _SelectForSingleState extends State<SelectForSingle> {
  @override
      ...
      children: [
        Container(
          ...
          child: Column(
            ...
            children: [
              LabelInfo(label: '下拉单选', required: true),
